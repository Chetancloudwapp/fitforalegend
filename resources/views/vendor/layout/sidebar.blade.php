<aside class="main-sidebar sidebar-dark-primary elevation-4"> 
    <a href="{{ url('vendor/vendor-dashboard')}}" class="brand-link"> 
    ...
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item"> 
                    <a href="{{ url('vendor/vendor-dashboard')}}" class="nav-link {{ Request::is('vendor/vendor-dashboard') ? 'active' : '' }}"> <i class="nav-icon fas fa-tachometer-alt"></i>
                ...
                <li class="nav-item"> 
                    <a href="{{ url('vendor/vendor-product')}}" class="nav-link {{ Request::is('vendor/vendor-product') || Request::is('vendor/vendor-product/add') ? 'active' : ''}}"> <i class="fa-solid fa-user"></i>&nbsp;&nbsp;
                        <p>Product</p>
                    </a> 
                </li>
                <li class="nav-item"> 
                ...
                <li class="nav-item"> 
                    <a href="{{ url('vendor/vendor-login')}}" class="nav-link"> <i class="nav-icon fas fa-th"></i>
                        <p> Logout </p>
                    </a> 
                </li>
            </ul>

            ...
            <div class="row">
                ...
                <div class="col-xl aside">
                    <div class="prd-grid-wrap">
                                        ...
                                        <div class="prd-inside">
                                            <div class="prd-img-area">
                                                <a href="{{ url('product_detail/'.$product['id'])}}" class="prd-img image-hover-scale image-container">
                                                    ...
                                                    <img src = "{{ asset('uploads/products/featuredImages/large/'. $product['featured_image'])}}">
                                            ...
                                            <div class="prd-info">
                                                <div class="prd-info-wrap">
                                                    ...
                                                    <div class="prd-description">{{ $product['description']}} </div>
                        ...
                        <div>{{ $get_products->withQueryString()->links()}}</div>
                    </div>
                </div>
            </div>
        </div>

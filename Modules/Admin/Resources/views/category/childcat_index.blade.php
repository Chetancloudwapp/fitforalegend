                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <h3 class="card-title nofloat"> <span>Child Category</span>
                            	<span> <a href="{{ url('admin/addsubsubcat') }}"> <button type="button" class="btn btn-block btn-primary">Add Child Categories</button> </a> </span>
                            </h3>
                        </div>
                        <div class="card-body">
                                    ...
                                    @foreach($ChildCategory as $childcategory)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <a href="{{ url('admin/addsubsubcat/'.$childcategory['id']) }}"> <i class="fa-solid fa-pencil"></i></a>

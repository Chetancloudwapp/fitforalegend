...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header text-center"> <a style="font-weight: 800; font-size: 32px;" href="index2.html" class="h1"><img src="{{ asset('admin/images/fitforalegend.png')}}" width="60%" ></a></div>
            <div class="card-body">

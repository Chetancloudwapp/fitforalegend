<aside class="main-sidebar sidebar-dark-primary elevation-4"> 
    <a href="{{ url('admin/dashboard')}}" style="background-color:white" class="brand-link"> 
        ...
        <img src="{{ asset('admin/images/fitforalegend.png')}}" alt="AdminLTE Logo" style="align-content: center" width="60%" height="80%">
    </a>
    <div class="sidebar">
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item"> 
                    <a href="{{ url('admin/product')}}" class="nav-link {{ Request::is('admin/product') || Request::is('admin/product/add') || Request::is('admin/brands') || Request::is('admin/brands/add') || Request::is('admin/color') ||  Request::is('admin/color/add') || Request::is('admin/variation/add/{id}') || Request::is('admin/size') || Request::is('admin/size/add') ? 'active' : '' }}"> <i class="fa-solid fa-bag-shopping"></i>&nbsp;&nbsp;&nbsp;
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item"> 
                            <a href="{{ url('admin/brands')}}" class="nav-link {{ Request::is('admin/brands') || Request::is('admin/brands/add') ? 'active' : '' }}"> <i class="far fa-circle nav-icon"></i>
                                <p> Brands </p>
                            </a> 
                        </li>
                        <li class="nav-item"> 

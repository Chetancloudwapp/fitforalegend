...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="card card-outline card-primary">
            <div class="card-header text-center"> <a style="font-weight: 800; font-size: 32px;" href="index2.html" class="h1">Vendor Login</a></div>
            <div class="card-body">
                ...
                @endif
                <form action="{{ url('vendor/vendor-login')}}" method="post">
                    @csrf
